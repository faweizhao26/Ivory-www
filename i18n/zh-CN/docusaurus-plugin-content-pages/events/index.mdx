...
export const EventsData = [
  {
    ...
    desc: "白鳝、冯若航、杨超超、张晨等嘉宾齐聚南京，六大议题涵盖 AI Agent、PITR、IvorySQL 兼容与异常恢复，面对面深度交流。",
    startTime: "2026-07-25",
    endTime: "2026-07-25",
    location: "线下活动（南京）",
    link: "/zh-cn/events/event-202611",
    img: "/img/events/event-202611.jpg"
  },
  {
    title: "直播预告｜PG 30 周年系列直播第四期：大规模PG生产环境——亿级用户、PB级数据的架构真相",
    desc: "唐成、林春、尹海文、刘智龙四位实战派齐聚，聊单机极限、分布式边界、MVCC 膨胀与真实案例复盘。",
    startTime: "2026-07-15",
    endTime: "2026-07-15",
    location: "线上直播",
    link: "/zh-cn/events/event-202610",
    img: "/img/events/event-202610.jpg"
  },
  {
  ...
  },
  {
    ...
    endTime: "2026-06-17",
    location: "线上直播",
    link: "/zh-cn/events/event-202608",
    img: "/img/events/event-202608.jpg"
  },
  {
    title: "活动回顾｜数据库开源发展联盟走进西安邮电大学——PG 校园行 PostgreSQL 技术峰会",
    desc: "IvorySQL 社区核心贡献者梁翔宇分享《AI + IvorySQL + 容器化：PG 的开源实践之路》，与西邮师生共探开源数据库技术前沿。",
    startTime: "2026-06-13",
    endTime: "2026-06-13",
    location: "线下活动（西安邮电大学）",
